...
plot_grid(
  ...
  subraction.plot(frac1 = c(2,3), frac2 = c(1,5), 
...
En este caso vamos a tomar un objeto que está dividido en séptimos de los cuales tenemos $3$; después a cada uno de esos séptimos los dividimos en $11$avos y de cada $11$ avo de su respectivo séptimo tomamos $4$. Algo como en la figura:
...
plot_grid(
  ...
  subraction.plot(frac1 = c(3,7), frac2 = c(4,11), 
                  xlab = "Cada uno de los séptimos se subdividió en 11 y de los 3 que se tenían se toman 4 subdivisiones")
)
```
...
plot_grid(
  ...
  subraction.plot(frac1 = c(5,7), frac2 = c(9,13), 
                  xlab = "Cada uno de los séptimos se subdividió en 13 y de los 5 que se tenían se toman 9 subdivisiones")
)
```

Podemos entonces plantearnos cómo se ve el caso general. Si tenemos un producto entre dos fracciones:
$$
...
```{r, fig.cap="$\\frac{a \\times c}{b \\times d}$", fig.width=3, fig.height = 2}
subraction.plot(frac1 = c(17,31), frac2 = c(22,30), xlab = "")
```

Y por tanto se tienen $a \times c$ pedazos de tamaño $b \times d$:
$$
...
2. <i class="em em-pencil2"></i>  Multiplica las siguientes fracciones, no justifiques:
...
3. <i class="em em-thinking_face"></i> Utiliza todo lo anterior para justificar que el cuadrado de una fracción es la fracción que contiene los cuadrados; es decir:
$$
\Big(\frac{a}{b}\Big)^2 =\frac{a^2}{b^2} 
$$
_Hint_ Explica primero cómo funciona el caso $\Big( \frac{4}{5} \Big)^2 = \frac{16}{25}$. 

4. <i class="em em-thinking_face"></i> Utiliza el resultado anterior para argumentar que la raíz de una fracción es la fracción que contiene las raíces.  
$$
\sqrt{\frac{a}{b}} =\frac{\sqrt{a}}{\sqrt{b}} 
$$
_Hint_ Explica primero cómo funciona el caso $\sqrt{\frac{16}{25}} = \frac{4}{5}$. 

5. <i class="em em-thinking_face"></i> Justifica con dibujos que si una fracción se le multiplica por un número idéntico al denominador, el denominador se elimina; es decir:
$$
b \times \frac{a}{b} = a
$$
...
6. Determina de manera rápida el valor de las siguientes multiplicaciones usando los anteriores puntos:
